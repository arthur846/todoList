...
const Registration = ()=>{
    return (
        <View style={StyleRegistration.container}>
            ...
            <ButtonRegister style={StyleButRegister.but} onClick={()=>(console.log('clicou'))}/>
            <View style={StyleRegistration.txtContainer}>
                <Text>Already have an account ? </Text>
                <TextButton label='Sign In' style={StyleRegistration.txtClick} onClick={()=>(console.log('clicou no sigin'))}/>
            </View>
        </View>
    )
}
